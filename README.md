...
| 🤖 **Autonomous Agent Bot** | Four modes — `notifier` (Telegram alerts), `worker` (LLM generates & delivers results on-chain), `indexer` and `buzon` (the mailbox, for whoever runs no server) — see [bot/](bot/README.md) |
