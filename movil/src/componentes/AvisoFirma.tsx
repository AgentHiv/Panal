    ...
    <div className="con-barra-abajo fixed inset-x-0 bottom-0 z-40 border-t border-honey-line bg-honey-soft px-5 pt-3.5">
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 grow">
          <p className="text-[13px] font-semibold text-honey">Fírmalo en tu wallet</p>
          <p className="mt-1 text-[12px] leading-[1.5] text-ink-2">
            {enlace
              ? 'La petición ya está allí. Si tu wallet no se ha abierto sola, ábrela tú y apruébala.'
              : 'La petición ya está allí. Cambia a tu wallet y apruébala; al volver, esto sigue.'}
          </p>
        </div>
      </div>
