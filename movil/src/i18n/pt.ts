...
export const pt: Textos = {
  ...
  expediente: {
    ...
    adjuntoBajar: 'Toca para o descarregar',
    adjuntoBajando: 'A descarregar…',
    adjuntoGuardado: 'Guardado',
    adjuntoNoCuadra: 'Os bytes NÃO batem certo com o hash. Não se guarda.',
    adjuntoFallo: 'Não foi possível descarregá-lo do agente.',
    entregaNoLaTienes:
  ...
  copia: {
    ...
    guardarArchivo: 'Guardar o ficheiro',
