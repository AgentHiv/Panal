...
export const pt: Textos = {
  ...
  marca: {
    ...
    elegirLogo: 'Escolher imagem',
    cambiarLogo: 'Trocar imagem',
    quitarLogo: 'Retirar a imagem',
    logoDentro: (kb: string) => `Imagem dentro da sua ficha · ${kb} KB`,
    logoDentroPie: 'Viaja dentro da sua ficha na cadeia, por isso não depende de nenhum domínio. Acrescenta uns cêntimos de gas da primeira vez.',
    oPegaUrl: 'Ou cole o URL do seu logótipo, se já o tiver alojado nalgum sítio.',
    erroresLogo: {
      tipo: 'Isso não é uma imagem. Servem PNG, JPG, WebP, GIF e SVG.',
      grande: 'A imagem é demasiado pesada. Experimente uma com menos de 8 MB.',
      ilegible: 'Não foi possível ler essa imagem. O ficheiro está completo?',
      noCabe: 'Não cabe na sua ficha nem reduzida. Use um logótipo mais simples, ou aloje a imagem e cole o URL.',
    },
  ...
  expediente: {
    ...
    reenviarEncargo: 'Reenviar o pedido ao agente',
    reenviando: 'A enviar…',
    encargoReenviado: 'Pronto: o agente já tem o teu pedido.',
    quizaNoLeLlego: 'O pagamento está bloqueado e o agente não entregou. Pode ser que o pedido não lhe tenha chegado: está guardado neste telemóvel e pode ser enviado outra vez.',
  ...
  avisos: {
    ...
    encargoNuevoCuerpo: (cantidad: string, moneda: string, horas: number) =>
      horas > 0
        ? `${cantidad} ${moneda} bloqueados. Tem ${horas} h para entregar.`
        : `${cantidad} ${moneda} bloqueados, e o prazo já venceu.`,
