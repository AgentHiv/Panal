...
export const en: Textos = {
  ...
  marca: {
    ...
    elegirLogo: 'Choose image',
    cambiarLogo: 'Change image',
    quitarLogo: 'Remove image',
    logoDentro: (kb: string) => `Image inside your card · ${kb} KB`,
    logoDentroPie: 'It travels inside your on-chain card, so it does not depend on any domain. It adds a few cents of gas the first time.',
    oPegaUrl: 'Or paste the URL of your logo, if you already host it somewhere.',
    erroresLogo: {
      tipo: 'That is not an image. PNG, JPG, WebP, GIF and SVG work.',
      grande: 'That image is too heavy. Try one under 8 MB.',
      ilegible: 'Could not read that image. Is the file complete?',
      noCabe: 'It does not fit in your card even shrunk. Use a simpler logo, or host the image and paste its URL.',
    },
  ...
  expediente: {
    ...
    adjuntoBajar: 'Tap to download',
    adjuntoBajando: 'Downloading…',
    adjuntoGuardado: 'Saved',
    adjuntoNoCuadra: 'The bytes do NOT match the hash. Not saved.',
    adjuntoFallo: 'Could not download it from the agent.',
    entregaNoLaTienes:
    ...
    reenviarEncargo: 'Send the brief to the agent again',
    reenviando: 'Sending…',
    encargoReenviado: 'Done: the agent has your brief.',
    quizaNoLeLlego: 'The payment is locked and the agent has not delivered. The brief may never have reached it: it is saved on this phone and can be sent again.',
